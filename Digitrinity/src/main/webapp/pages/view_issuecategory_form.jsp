	...
	<div class="content-wrapper content-wrapper--with-bg"
		...
		<div class="list-group">
			<form:form method="POST" modelAttribute="issueCategoryFormBean"
				...
				<input type="hidden" id="issueCatID" name="issueCatID"
					value="${issueCategoryFormBean.issueCatID}" />
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
							...
							<button class="btn btn-primary" title="SUBMIT"
								onclick="submitIssueCategory(); return false;" type="button">SUBMIT</button>
						</div>
					</div>
									...
									<div class="box-body">
										<div class="table-responsive">
											<table class="table table-bordered table-striped dataTable"
												...
												<tbody>
													<c:forEach var="rcaReport"
														items="${issueCategoryMasterList}">
														<tr>
															...
															<td align="center" class="width-5"><img
																...
																onclick="javascript:viewEditIssueCatForm('${rcaReport.issueCatID}');" /></td>

															<td align="center" class="width-5"><img
																alt="INACTIVE"
																src="<c:url value="/resources/images/wrong_tick.png"/>"
																height="20px" width="20px" title="Click for delete"
																onclick="javascript:deleteIssueCatForm('${rcaReport.issueCatID}');" /></td>
