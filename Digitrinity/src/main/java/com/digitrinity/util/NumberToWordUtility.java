...
public class NumberToWordUtility
{
	...
	public static String convertNumberToWords(BigDecimal parameter)
	{
		...
		if (quotient > 0)
		{
			word.append(convert(quotient) + " Lakh ");
		}
		...
		if (quotient > 0)
		{
			word.append(convert(quotient) + " Thousand ");
		}
		...
		if (quotient > 0)
		{
			word.append(convert(quotient) + " Hundred ");
		}

		number = number % 100;
		if (number != 0)
		{
			word.append(convert((int) number) + " ");
		}
